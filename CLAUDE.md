...
- 选取依据：shadow_runner 4-13~5-08 测试，v8_tight +15.32% / v8_base +6.89%
- 健康度：warning（胜率 52.4%、回撤 10.1%、连亏 5 笔），建议每周用 `shadow_runner --weekly` 复检
